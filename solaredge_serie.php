...
do {
  ...
  ****************************************************************************/
  ...
  $aktuelleDaten["AC_Wirkleistung_Faktor"] = $funktionen->hexdecs(substr($rc,378,4));
  $aktuelleDaten["AC_Wirkleistung"] = $funktionen->solaredge_faktor(hexdec(substr($rc,374,4)),$aktuelleDaten["AC_Wirkleistung_Faktor"]);
  ...
  $aktuelleDaten["M1Version"] = trim($funktionen->Hex2String(substr($rc,186,32)));
  $aktuelleDaten["M1Seriennummer"] = trim($funktionen->Hex2String(substr($rc,218,64)));
  // $aktuelleDaten["4"] = substr($rc,282,4);
  $aktuelleDaten["C_SunSpec_DID"] = hexdec(substr($rc,286,4));
